        ...
        <main>
            ...
            <form action="orderconfirmation.php" method="post">
                <fieldset>
                    ...
                    <input type="radio" name="shape" id="round" value="round">
                    ...
                    <input type="radio" name="crust" id="original" value="original">
                    ...
                    <label style="color:#be2f2f"><strong>Toppings (Select all you would like):</strong></label>
                    <br>
                    <strong>Meats:</strong>
                    <br>
